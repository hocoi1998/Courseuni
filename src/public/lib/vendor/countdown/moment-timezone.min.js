!(function (t, e) {
    ...
    function c(t, e) {
        for (var n, o; (o = 6e4 * (((e.at - t.at) / 12e4) | 0)); )
            (n = new a(new Date(t.at + o))).offset === t.offset
                ? (t = n)
                : (e = n);
        return t;
    }
    ...
    function S(e) {
        ...
        return (
            r && !t.isMoment(e) && w(s) && s.add(r.parse(s), 'minutes'),
            s.tz(o),
            s
        );
    }
    ...
    (Z < 2 || (2 === Z && F < 6)) &&
        ...
        (u.prototype.scoreOffsetAt = function (t) {
            (this.offsetScore += Math.abs(
                this.zone.utcOffset(t.at) - t.offset,
            )),
